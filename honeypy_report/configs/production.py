...
TEST_IP="test-service.default.svc.cluster.local"
TEST_PORT=80
TEST_URL="http://" + TEST_IP
TEST_DB="test"

# Report Service Configs
REPORT_IP="report-service.default.svc.cluster.local"
REPORT_PORT=80
REPORT_URL="http://" + REPORT_IP
REPORT_DB="report"

# Host Service Configs
HOST_IP="host-service.default.svc.cluster.local"
HOST_PORT=80
HOST_URL="http://" + HOST_IP
HOST_DB="host"

# Set Service Configs
SET_IP="set-service.default.svc.cluster.local"
SET_PORT=80
SET_URL="http://" + SET_IP
SET_DB="set"
...
# Redis Configs
REDIS_HOST="honeypy-rds-redis.default.svc.cluster.local"
REDIS_PORT=6379
